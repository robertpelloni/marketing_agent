...
func HandleGetPatient_omop_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchPatients_omop_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

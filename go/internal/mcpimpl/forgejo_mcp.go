...
func HandleListRepositories_forgejo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetIssue_forgejo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	host, _ :=getString(args, "host")
	owner, _ :=getString(args, "owner")

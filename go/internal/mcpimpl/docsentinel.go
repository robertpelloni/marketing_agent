...
func HandleSearchDocs_docsentinel(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDoc_docsentinel(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

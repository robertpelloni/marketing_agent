...
func HandleGetDependencies_depwire(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListPackages_depwire(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

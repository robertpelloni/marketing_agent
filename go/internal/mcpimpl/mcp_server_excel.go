...
func HandleReadExcel_mcp_server_excel(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleWriteExcel_mcp_server_excel(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	path, _ :=getString(args, "path")

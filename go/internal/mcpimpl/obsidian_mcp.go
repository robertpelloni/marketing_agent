...
func HandleListNotes_obsidian_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetNote_obsidian_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	base, _ :=getString(args, "apiUrl")
	if base == "" {
		base = "http://localhost:27123"
	}

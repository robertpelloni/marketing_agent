...
func HandleSearchPackages_jsr_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetPackage_jsr_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListProjects_codebeamer_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetProject_codebeamer_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

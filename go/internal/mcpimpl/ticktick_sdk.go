...
func HandleCreateTask_ticktick_sdk(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListTasks_ticktick_sdk(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

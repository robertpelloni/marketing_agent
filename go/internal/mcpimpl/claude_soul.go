...
func HandleGetQuote_claude_soul(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleHello_claude_soul(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

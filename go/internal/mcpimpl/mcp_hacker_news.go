...
func HandleGetStory_mcp_hacker_news(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	id, _ :=getInt(args, "id")
	if id == 0 {
...
func HandleGetTopStories_mcp_hacker_news(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

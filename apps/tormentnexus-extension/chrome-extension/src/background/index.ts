...
const DEFAULT_SSE_URL = 'http://localhost:7778/api/sse';
const DEFAULT_WEBSOCKET_URL = 'ws://localhost:7778/api/ws';
const DEFAULT_STREAMABLE_HTTP_URL = 'http://localhost:7778';

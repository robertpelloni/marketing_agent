...
def call_llm(prompt, max_tokens=4096, temperature=0.7):
    ...
    data = {
        ...
        "messages": [
            {
                "role": "system",
                "content": "You are a technical writer for TormentNexus. Write clear, authoritative blog posts about AI infrastructure. Be specific, technical, and compelling. Output clean markdown.",
            },

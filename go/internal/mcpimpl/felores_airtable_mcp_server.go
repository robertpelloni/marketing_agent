...
func HandleListRecords_felores_airtable_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetRecord_felores_airtable_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "apiKey")
	baseId, _ :=getString(args, "baseId")
	tableId, _ :=getString(args, "tableId")

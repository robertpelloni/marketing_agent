...
func HandleHello_consult7(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	return ok("Hello from Consult7!")
}

func HandleEcho_consult7(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

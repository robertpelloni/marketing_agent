...
func HandleGetInvoice_l402_kit(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePayInvoice_l402_kit(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	api, _ :=getString(args, "api_url")

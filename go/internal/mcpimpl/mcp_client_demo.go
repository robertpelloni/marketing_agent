...
func HandleX_mcp_client_demo(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleY_mcp_client_demo(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleGetContact_mcp_hubspot(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListContacts_mcp_hubspot(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleSearch_mcp_server_milvus(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleInsert_mcp_server_milvus(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	collection, _ :=getString(args, "collection_name")

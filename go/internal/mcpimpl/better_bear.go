...
func HandleCreateNote_better_bear(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchNotes_better_bear(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

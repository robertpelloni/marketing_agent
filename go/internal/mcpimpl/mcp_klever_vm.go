...
func HandleGetAccount_mcp_klever_vm(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetTransaction_mcp_klever_vm(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

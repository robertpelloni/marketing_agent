...
func HandleListDevices_mcp_server_hc3(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDeviceStatus_mcp_server_hc3(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

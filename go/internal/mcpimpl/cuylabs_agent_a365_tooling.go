...
func HandleSendMail_cuylabs_agent_a365_tooling(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateCalendarEvent_cuylabs_agent_a365_tooling(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	subject, _ :=getString(args, "subject")

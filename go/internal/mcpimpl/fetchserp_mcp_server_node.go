...
func HandlePing_fetchserp_mcp_server_node(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	return ok("pong")
}

func HandleSearch_fetchserp_mcp_server_node(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

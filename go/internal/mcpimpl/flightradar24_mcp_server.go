...
func HandleGetFlight_flightradar24_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchFlights_flightradar24_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListModels_genai_toolbox(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGenerateText_genai_toolbox(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleGetProduct_gumroad_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListProducts_gumroad_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	token := os.Getenv("GUMROAD_TOKEN")
	if token == "" {
		return err("GUMROAD_TOKEN not set")
}

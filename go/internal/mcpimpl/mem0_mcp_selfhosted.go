...
func HandleAddMemory_mem0_mcp_selfhosted(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMemory_mem0_mcp_selfhosted(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	userID, _ :=getString(args, "user_id")
	if userID == "" {

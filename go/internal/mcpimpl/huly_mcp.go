...
func HandleListProjects_huly_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetProject_huly_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

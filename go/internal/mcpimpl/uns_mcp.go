...
func HandleGetInfo_uns_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearch_uns_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

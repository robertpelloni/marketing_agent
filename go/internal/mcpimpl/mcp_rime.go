...
func HandleListVoices_mcp_rime(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleTextToSpeech_mcp_rime(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

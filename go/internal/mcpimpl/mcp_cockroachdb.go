...
func HandleQuery_mcp_cockroachdb(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListTables_mcp_cockroachdb(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

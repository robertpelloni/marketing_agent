...
func HandleSendEmail_zoho_mail_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListEmails_zoho_mail_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

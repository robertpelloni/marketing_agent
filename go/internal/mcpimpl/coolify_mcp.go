...
func HandleListProjects_coolify_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListDeployments_coolify_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "base_url")
	token, _ :=getString(args, "api_token")

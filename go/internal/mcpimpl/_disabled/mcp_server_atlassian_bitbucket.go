...
func HandleListWorkspaces_mcp_server_atlassian_bitbucket(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListRepositories_mcp_server_atlassian_bitbucket(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	token, _ :=getString(args, "token")

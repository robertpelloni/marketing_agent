...
func HandleX_openai_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleY_openai_mcp_client(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

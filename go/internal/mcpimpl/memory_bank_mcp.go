...
func HandleGetMemory_memory_bank_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSetMemory_memory_bank_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	key, _ :=getString(args, "key")

...
func HandleListDashboards_mcp_superset(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDataset_mcp_superset(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "base_url")

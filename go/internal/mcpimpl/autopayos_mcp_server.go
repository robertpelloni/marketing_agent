...
func HandleCreatePayment_autopayos_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetPayment_autopayos_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleConnect_unreal_ai_connection(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCommand_unreal_ai_connection(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	host, _ :=getString(args, "host")

...
func HandleListTasks_mcp_server_taskwarrior(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleAddTask_mcp_server_taskwarrior(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListNotes_jotdown(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreateNote_jotdown(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

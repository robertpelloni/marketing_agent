...
func HandleSearch_xbghc_zotero_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetItem_xbghc_zotero_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

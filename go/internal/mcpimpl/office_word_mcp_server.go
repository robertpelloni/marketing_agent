...
func HandleCreateDocument_office_word_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleReadDocument_office_word_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	fileName, _ :=getString(args, "file_name")
	if fileName == "" {
		return err("file_name is required")
}

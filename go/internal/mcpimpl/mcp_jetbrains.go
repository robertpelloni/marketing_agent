...
func HandleOpenFile_mcp_jetbrains(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRunCommand_mcp_jetbrains(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

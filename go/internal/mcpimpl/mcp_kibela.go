...
func HandleSearchNotes_mcp_kibela(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetNote_mcp_kibela(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

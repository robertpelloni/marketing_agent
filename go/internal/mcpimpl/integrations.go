...
func HandleListIntegrations_integrations(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetIntegration_integrations(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

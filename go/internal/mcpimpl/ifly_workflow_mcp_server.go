...
func HandleListWorkflows_ifly_workflow_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetWorkflowStatus_ifly_workflow_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	base := os.Getenv("IFLY_WORKFLOW_API_BASE")
	if base == "" {
		base = "http://localhost:8080"
	}

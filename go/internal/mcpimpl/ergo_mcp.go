...
func HandleGetBlock_ergo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetTransaction_ergo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListTopics_mcp_confluent(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetCluster_mcp_confluent(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "api_key")
	apiSecret, _ :=getString(args, "api_secret")
	if apiKey == "" || apiSecret == "" {

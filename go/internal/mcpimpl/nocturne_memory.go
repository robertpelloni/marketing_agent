...
func HandleSetMemory_nocturne_memory(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMemory_nocturne_memory(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	key, _ :=getString(args, "key")
	if key == "" {

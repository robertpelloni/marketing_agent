...
func HandleListAccounts_google_tag_manager_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListContainers_google_tag_manager_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

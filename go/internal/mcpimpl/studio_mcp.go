...
func HandleListProjects_studio_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetProject_studio_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

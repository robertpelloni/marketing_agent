...
func HandleListRepositories_mcp_server_bitbucket(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetUser_mcp_server_bitbucket(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

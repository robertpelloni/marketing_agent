...
func HandleGetBill_congressmcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMember_congressmcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

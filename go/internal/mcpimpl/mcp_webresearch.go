...
func HandleWebSearch_mcp_webresearch(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleFetchURL_mcp_webresearch(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

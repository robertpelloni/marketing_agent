...
func HandleSearchMovie_tmdb_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMovieDetails_tmdb_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

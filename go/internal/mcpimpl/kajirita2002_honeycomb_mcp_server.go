...
func HandleListDatasets_kajirita2002_honeycomb_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRunQuery_kajirita2002_honeycomb_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "apiKey")

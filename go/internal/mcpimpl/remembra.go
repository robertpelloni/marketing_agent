...
func HandleRemember_remembra(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRecall_remembra(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleSearch_trieve(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDocument_trieve(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

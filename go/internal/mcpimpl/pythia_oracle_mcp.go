...
func HandleGetPrice_pythia_oracle_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCheckStatus_pythia_oracle_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleReadNote_obsidian_mcp_plugin(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchNotes_obsidian_mcp_plugin(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

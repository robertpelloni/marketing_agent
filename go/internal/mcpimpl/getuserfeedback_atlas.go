...
func HandleGetFile_getuserfeedback_atlas(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListDir_getuserfeedback_atlas(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	owner, _ :=getString(args, "owner")
	repo, _ :=getString(args, "repo")
	path, _ :=getString(args, "path")
	if owner == "" || repo == "" {

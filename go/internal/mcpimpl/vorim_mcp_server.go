...
func HandleGetCourses_vorim_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetCourse_vorim_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

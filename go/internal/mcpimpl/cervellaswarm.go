...
func HandleListItems_cervellaswarm(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetItem_cervellaswarm(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleGeocode_chatspatial(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleReverseGeocode_chatspatial(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

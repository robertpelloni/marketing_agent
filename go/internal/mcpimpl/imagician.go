...
func HandleGenerate_imagician(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleDescribe_imagician(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

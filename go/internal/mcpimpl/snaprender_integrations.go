...
func HandleGetIntegration_snaprender_integrations(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListIntegrations_snaprender_integrations(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

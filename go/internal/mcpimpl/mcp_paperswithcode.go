...
func HandleSearchPapers_mcp_paperswithcode(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetPaper_mcp_paperswithcode(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListFlows_mcp_flowcore_platform(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetFlow_mcp_flowcore_platform(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

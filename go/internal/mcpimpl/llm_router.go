...
func HandleListModels_llm_router(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleChat_llm_router(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

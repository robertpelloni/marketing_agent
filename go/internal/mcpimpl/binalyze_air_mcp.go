...
func HandleListCollections_binalyze_air_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetCollection_binalyze_air_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	apiKey, _ :=getString(args, "api_key")
	baseURL, _ :=getString(args, "base_url")
	if baseURL == "" {
		baseURL = "https://api.binalyze.com"

...
func HandleGetIssue_mcp_server_atlassian_jira(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchIssues_mcp_server_atlassian_jira(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

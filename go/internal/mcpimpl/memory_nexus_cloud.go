...
func HandleAddMemory_memory_nexus_cloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchMemory_memory_nexus_cloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleRender_diagrammo_dgmo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandlePreview_diagrammo_dgmo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	diagram, _ :=getString(args, "diagram")
	if diagram == "" {
		return err("diagram parameter is required")
}

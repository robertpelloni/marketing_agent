...
func HandleGeocode_baidumap_mcp_server_baidu_map(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleReverseGeocode_baidumap_mcp_server_baidu_map(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	ak, _ :=getString(args, "api_key")

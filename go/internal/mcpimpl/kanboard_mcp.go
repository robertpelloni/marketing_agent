...
func HandleListProjects_kanboard_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListTasks_kanboard_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	baseURL, _ :=getString(args, "base_url")
	apiToken, _ :=getString(args, "api_token")

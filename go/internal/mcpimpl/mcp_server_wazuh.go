...
func HandleListAgents_mcp_server_wazuh(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetAgent_mcp_server_wazuh(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

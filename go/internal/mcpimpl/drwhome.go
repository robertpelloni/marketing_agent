...
func HandleSearch_drwhome(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetInfo_drwhome(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

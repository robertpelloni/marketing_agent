...
func HandleProxy_mcp_client_and_proxy(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleConnect_mcp_client_and_proxy(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

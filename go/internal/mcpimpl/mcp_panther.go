...
func HandleGetFact_mcp_panther(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleVersion_mcp_panther(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

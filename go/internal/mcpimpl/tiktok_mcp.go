...
func HandleGetUserInfo_tiktok_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchVideos_tiktok_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

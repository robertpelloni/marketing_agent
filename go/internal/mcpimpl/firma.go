...
func HandleSign_firma(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleVerify_firma(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	msg, _ :=getString(args, "message")

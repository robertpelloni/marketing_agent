...
func HandleQuery_mcp_rag_local(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleAdd_mcp_rag_local(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

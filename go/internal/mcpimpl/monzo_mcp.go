...
func HandleGetAccounts_monzo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetBalance_monzo_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

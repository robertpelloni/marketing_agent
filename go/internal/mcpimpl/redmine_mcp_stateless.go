...
func HandleGetIssue_redmine_mcp_stateless(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListIssues_redmine_mcp_stateless(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	base, _ :=getString(args, "base_url")
	key, _ :=getString(args, "api_key")

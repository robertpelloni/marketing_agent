...
func HandleGetSleep_garmin_mcp_unofficial(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetSteps_garmin_mcp_unofficial(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	date, _ :=getString(args, "date")

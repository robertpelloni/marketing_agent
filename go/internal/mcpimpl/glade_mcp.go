...
func HandleGetProjectInfo_glade_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteCommand_glade_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleListEvents_gongrzhe_server_calendar_autoauth_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListCalendars_gongrzhe_server_calendar_autoauth_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

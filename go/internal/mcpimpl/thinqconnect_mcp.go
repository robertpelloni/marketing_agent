...
func HandleGetDevices_thinqconnect_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDevice_thinqconnect_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

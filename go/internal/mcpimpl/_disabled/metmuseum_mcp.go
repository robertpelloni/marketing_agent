...
func HandleSearchArtworks_metmuseum_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetObject_metmuseum_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

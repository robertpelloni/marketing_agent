...
func HandleGetRepo_nshkrdotcom(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchRepos_nshkrdotcom(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

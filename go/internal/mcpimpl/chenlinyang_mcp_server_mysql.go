...
func HandleQuery_chenlinyang_mcp_server_mysql(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecute_chenlinyang_mcp_server_mysql(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	base, _ :=getString(args, "base_url")
	query, _ :=getString(args, "query")
	body, e := json.Marshal(map[string]string{"query": query})
	if e != nil {

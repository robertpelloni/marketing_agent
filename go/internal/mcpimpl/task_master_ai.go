...
func HandleCreateTask_task_master_ai(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListTasks_task_master_ai(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

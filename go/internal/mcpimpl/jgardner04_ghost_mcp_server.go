...
func HandleGetPosts_jgardner04_ghost_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreatePost_jgardner04_ghost_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	url, _ :=getString(args, "url")
	apiKey, _ :=getString(args, "api_key")

...
func HandleGreet_modelcontextprotocol_jl(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleEcho_modelcontextprotocol_jl(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleCreateMemory_memory_plus(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRecallMemory_memory_plus(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	word, _ :=getString(args, "word")
	if word == "" {

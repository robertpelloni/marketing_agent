...
func HandleQueryDatabase_notion_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreatePage_notion_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleGetProduct_shopgraph(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleListProducts_shopgraph(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

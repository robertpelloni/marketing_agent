...
func HandleListTrips_wanderlog_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetTrip_wanderlog_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

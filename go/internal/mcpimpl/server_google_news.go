...
func HandleGetNews_server_google_news(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchNews_server_google_news(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

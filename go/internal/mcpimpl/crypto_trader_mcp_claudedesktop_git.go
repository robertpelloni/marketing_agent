...
func HandleGetPrice_crypto_trader_mcp_claudedesktop_git(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleExecuteTrade_crypto_trader_mcp_claudedesktop_git(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	symbol, _ :=getString(args, "symbol")

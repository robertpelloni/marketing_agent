...
func HandleListWorkflows_kadoa_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleRunWorkflow_kadoa_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	base, _ :=getString(args, "api_base")
	if base == "" {
		return err("api_base is required")
}

...
func HandleGetChainInfo_chainanalyzer_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetTransaction_chainanalyzer_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

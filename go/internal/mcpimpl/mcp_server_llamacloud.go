...
func HandleListModels_mcp_server_llamacloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGenerate_mcp_server_llamacloud(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

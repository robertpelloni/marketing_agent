...
func HandleListInbox_ldm_inbox_check_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetMessage_ldm_inbox_check_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

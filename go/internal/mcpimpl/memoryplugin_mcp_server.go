...
func HandleCreateMemory_memoryplugin_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchMemory_memoryplugin_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

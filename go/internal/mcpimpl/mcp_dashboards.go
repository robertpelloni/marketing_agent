...
func HandleListDashboards_mcp_dashboards(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDashboard_mcp_dashboards(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

...
func HandleExecuteCommand_openara_cli(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleOpenApplication_openara_cli(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

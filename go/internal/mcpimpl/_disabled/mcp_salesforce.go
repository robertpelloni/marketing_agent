...
func HandleQuery_mcp_salesforce(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleDescribe_mcp_salesforce(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

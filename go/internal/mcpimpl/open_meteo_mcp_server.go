...
func HandleGetCurrentWeather_open_meteo_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetForecast_open_meteo_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	lat, _ :=getString(args, "latitude")
	lon, _ :=getString(args, "longitude")

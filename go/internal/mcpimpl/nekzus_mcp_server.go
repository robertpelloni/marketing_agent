...
func HandleGetPackage_nekzus_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleSearchPackages_nekzus_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {

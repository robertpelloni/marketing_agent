...
func HandleGetSite_neotoma(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetDataset_neotoma(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	id, _ :=getString(args, "id")
	if id == "" {
		return err("id is required")
	}

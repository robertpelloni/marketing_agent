...
func HandleGetMember_brilliant_directories_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleCreatePost_brilliant_directories_mcp(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
	siteURL, _ :=getString(args, "site_url")
	apiKey, _ :=getString(args, "api_key")

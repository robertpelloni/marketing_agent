...
func HandleListRoutes_rails_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
...
func HandleGetVersion_rails_mcp_server(ctx context.Context, args map[string]interface{}) (ToolResponse, error) {
